...
public class KonfirmasiAnggota extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        konfiranggota.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Noanggota", "Nama", "NIS", "Tempat Tanggal Lahir", "Jurusan"
            }
        ));
    ...
    private void konfiranggotaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_konfiranggotaMouseClicked
         ...
         nama = konfiranggota.getValueAt(konfiranggota.getSelectedRow(), 1).toString();
         nis = konfiranggota.getValueAt(konfiranggota.getSelectedRow(), 2).toString();
         ttl = konfiranggota.getValueAt(konfiranggota.getSelectedRow(), 3).toString();
         jurusan = konfiranggota.getValueAt(konfiranggota.getSelectedRow(), 4).toString();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try{
           stt = CC.createStatement();
            stt.executeUpdate("INSERT INTO laporananggota VALUES('"+ id+ "','" 
                    + nis + "','"
                    + nama + "','"
                    + ttl + "','"
                    + jurusan+ "','"
